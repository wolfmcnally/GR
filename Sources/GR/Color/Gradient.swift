...
public struct ColorFrac: Equatable {
    ...
    public static func == (lhs: ColorFrac, rhs: ColorFrac) -> Bool {
        lhs.color == rhs.color && lhs.frac == rhs.frac
    }
}
...
public struct ColorFracHandle: Equatable {
    ...
    public static func == (lhs: ColorFracHandle, rhs: ColorFracHandle) -> Bool {
        lhs.color == rhs.color && lhs.frac == rhs.frac && lhs.handle == rhs.handle
    }
}
...
public struct ColorFracHandleGradient: Equatable {
    ...
    public static func == (lhs: ColorFracHandleGradient, rhs: ColorFracHandleGradient) -> Bool {
        lhs.colorFracHandles == rhs.colorFracHandles
    }
}

public struct Gradient {
    public let colorFunc: ColorFunc

    public init(_ colorFunc: @escaping ColorFunc) {
...
extension Gradient {
    public static let grayscale = Gradient(blend(from: .black, to: .white))

    // Color Harmonies, Analogous
    public static let goldRedOrange = Gradient(makeThreeColor(.gold, .red, .orange))
    public static let bluegreenBlueGreen = Gradient(makeThreeColor(.blueGreen, .mediumBlue, .darkGreen))
    public static let blueMagentaRed = Gradient(makeThreeColor(.deepBlue, .magenta, .red))
    public static let yellowGoldGreen = Gradient(makeThreeColor(.yellow, .gold, .darkGreen))
    public static let chartreuseYellowGreen = Gradient(makeThreeColor(.chartreuse, .yellow, .darkGreen))

    // Color Harmonies, Primary Complementary
    public static let orangeMediumblue = Gradient(makeTwoColor(.orange, .mediumBlue))
    public static let purpleGold = Gradient(makeTwoColor(.purple, .gold))
    public static let redGreen = Gradient(makeTwoColor(.red, .darkGreen))

    // Color Harmonies, Secondary Complementary
    public static let chartreusePurple = Gradient(makeTwoColor(.chartreuse, .purple))
    public static let greenOrange = Gradient(makeTwoColor(.darkGreen, .orange))
    public static let deepblueOrange = Gradient(makeTwoColor(.deepBlue, .orange))

    // Color Harmonies, Split Complementary
    public static let bluePurpleOrange = Gradient(makeThreeColor(.mediumBlue, .purple, .orange))
    public static let yellowBluePurple = Gradient(makeThreeColor(.yellow, .mediumBlue, .purple))
    public static let chartreuseBlueRed = Gradient(makeThreeColor(.chartreuse, .deepBlue, .red))
    public static let greenMagentaOrange = Gradient(makeThreeColor(.darkGreen, .magenta, .orange))
    public static let bluegreenRedOrange = Gradient(makeThreeColor(.blueGreen, .red, .orange))
    public static let orangeBlueOrange = Gradient(makeThreeColor(.orange, .mediumBlue, .orange))
    public static let goldPurpleOrange = Gradient(makeThreeColor(.gold, .purple, .orange))
    public static let chartreuseBlueOrange = Gradient(makeThreeColor(.chartreuse, .deepBlue, .orange))

    // Earth Tones
    public static let coffee = Gradient(makeThreeColor(
    ...
    public static let valentine = Gradient(makeThreeColor(
    ...
    public static let strata1 = Gradient(blend(colorFracHandles: [
    ...
    public static let strata2 = Gradient(blend(colorFracs: [
    ...
    public static let strata3 = Gradient(blend(colorFracs: [
    ...
    // Seasons
    public static let spring = Gradient(blend(colorFracHandles: [
    ...
    public static let summer = Gradient(blend(colorFracHandles: [
    ...
    public static let autumn = Gradient(blend(colorFracHandles: [
    ...
    public static let winter = Gradient(blend(colorFracHandles: [
    ...
    // Nature
    public static let sky1 = Gradient(blend(colorFracHandles: [
    ...
    public static let sky2 = Gradient(blend(colorFracHandles: [
    ...
    public static let sky3 = Gradient(blend(colorFracHandles: [
    ...
    public static let sky4 = Gradient(blend(colorFracHandles: [
    ...
    public static let water1 = Gradient(blend(colorFracs: [
    ...
    public static let water2 = Gradient(blend(colors: [
    ...
    // Spectra
    public static let redYellowBlue = Gradient(makeThreeColor(.red, .yellow, .blue))
    public static let spectrum = Gradient(blend(colors: [
